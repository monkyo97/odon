...
import { Building2, User, Shield, DollarSign } from 'lucide-react';
import { ClinicSettings } from './components/ClinicSettings';
import { UserSettings } from './components/UserSettings';
import { SecuritySettings } from './components/SecuritySettings';
import { TreatmentCosts } from './components/TreatmentCosts';
...
export const Settings: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'clinic' | 'user' | 'security' | 'user_dentist' | 'costs'>(
  ...
  const tabs =
    role === 'admin'
      ? [
        ...
        { id: 'costs', label: 'Costo de Tratamiento', icon: DollarSign },
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-6">
          ...
          {activeTab === 'costs' && <TreatmentCosts />}
